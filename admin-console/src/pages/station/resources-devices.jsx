...
import { resourceDevices } from 'data/sinoport-adapters';

export default function StationResourcesDevicesPage() {
  return (
    <Grid container rowSpacing={3} columnSpacing={3}>
      <Grid size={12}>
        <PageHeader eyebrow="Devices" title="PDA 设备绑定" description="按站点、角色和设备查看 PDA Device 绑定关系。" chips={['PDA', 'Device Owner', 'Role Mapping']} />
      </Grid>
      <Grid size={12}>
        <MainCard title="设备绑定">
          <Table size="small">
