...
export const searchData = [
  ...
  },
  {
    ...
    childs: [
      ...
      { id: 'station-inbound-overview', title: '进港总览', icon: <ImportOutlined />, path: '/station/inbound' },
      ...
      { id: 'station-outbound-overview', title: '出港总览', icon: <ExportOutlined />, path: '/station/outbound' },
